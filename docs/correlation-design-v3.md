...
## Note on OS package checksums

The OS packages are published without checksums, which means users cannot verify their integrity.
This issue is independent of the correlation design and should be addressed by the build process.
```