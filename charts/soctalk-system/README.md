...
**Status: V1 alpha.** Templates cover the MVP control plane. See `docs/v1/` for context.
...
2. **NetworkPolicy-enforcing CNI**: Cilium is the supported primary path (see `docs/v1/P0-3-cni-networkpolicy.md`). Calico is a documented alternate.
